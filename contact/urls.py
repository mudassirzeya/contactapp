...
from .views import login_page, add_admin, admin_page, contacts_home_page, logout_user, bulk_contact_upload, filter_contact, filter_contact_web_page, add_user, user_info_page, report_contact, recieve_contact_id, edit_contact, contact_profile, delete_contact
